...
&nbsp; - `data\_processed/panel/panel\_coherencia\_ue.parquet`  
...
&nbsp;  - Editar la ruta del origen que apunta a `panel\_coherencia\_ue.parquet` para que coincida con la ubicación local de:
...
&nbsp; - `Panel` – panel analítico país–año (`panel\_coherencia\_ue.parquet`).
